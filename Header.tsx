...
export const Header = () => {
  ...
  return (
    <div className="bg-white">
      <div className="px-4 py-2 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:mx-auto">
        <div className="relative flex items-center justify-between">
          ...
          >
            ...
            <span className="ml-2 text-xl font-bold tracking-wide text-cyan-700 uppercase">
              Neurology & Sleep
            </span>
          </a>
