    ...
    <div className=" testImage">
      ...
      <div className="text-center">
            <h2 className="mx-auto text-shadow-md ">
              ...
              <span className="text-[#24598C]/50">Our </span>
              <span className="font-bold text-[#24598C]/80">Team</span>
            </h2>
      <div className="grid gap-10 mx-auto lg:grid-cols-2 lg:max-w-screen-lg">
        <div className="grid sm:grid-cols-3 bg-slate-200 rounded-3xl">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <p className="mb-4 text-xs text-gray-800">Dr</p>
            <p className="mb-4 text-sm tracking-wide text-gray-800">Whatever</p>
        ...
        <div className="grid sm:grid-cols-3 bg-slate-200 rounded-3xl">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <p className="mb-4 text-xs text-gray-800">Dr</p>
            <p className="mb-4 text-sm tracking-wide text-gray-800">Hennesy</p>
            <div className="flex items-center space-x-3">
              <a
                href="/"
                className="text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400"
        ...
        <div className="grid sm:grid-cols-3 bg-slate-200 rounded-3xl">
          ...
          <div className="flex flex-col justify-center mt-5 sm:mt-0 sm:p-5 sm:col-span-2">
            ...
            <p className="mb-4 text-sm tracking-wide text-gray-800">Bacon</p>
            <div className="flex items-center space-x-3">
              <a
                href="/"
                className="text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400"
