...
const Hero = () => {
  return (
    <div className="relative lg:border-b-2 flex flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0">
      <div className="inset-y-0 top-0 right-0 z-0 w-full max-w-xl px-4 mx-auto md:px-0 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-7/12 lg:max-w-full lg:absolute lg:my-0 xl:px-0">
        <svg
      ...
      <div className=" relative flex flex-col items-start w-fill max-w-xl px-4 mx-auto md:px-0 lg:mx-32 lg:max-w-3xl lg:flex-row ">
        <div className=" lg:z-50 lg:bg-white mb-10 lg:my-20 lg:max-w-2xl lg:pl-7">
          <h2 className="mb-8 font-sans text-3xl font-bold tracking-tight uppercase sm:text-4xl sm:leading-none text-center ">
            Welcome To
