...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" className="bg-white border-b -mb-.5 border-cyan-700">
      {({ open }) => (
        <>
          <div className="max-w-7xl lg:max-w-full lg:mx-32 mx-auto px-2 sm:px-6 ">
            <div className="relative flex items-center justify-between h-16 ">
              ...
              <div className="flex-1 flex md:items-stretch sm:justify-start ">
                ...
                <div className="sm:flex-1 sm:my-auto sm:mx-auto">
                        ...
                        <Link href={item.href} key={item.name}>
                          <a
                            className={classNames(
                              ' px-1 pt-1 border-b-2 text-md font-medium',
