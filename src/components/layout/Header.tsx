      ...
      <div className='mx-auto  flex justify-center bg-[#F7FDFE] sm:px-2 md:flex-row md:items-center md:px-10 lg:mx-auto  lg:justify-evenly'>
        <div className='my-2 flex'>
          <Link href='tel:4809676888' passHref>
            <a>
              <button className='text-md font-small flex items-center justify-center space-x-2 rounded-lg px-5  font-semibold text-[#107E8E] hover:border-[#5582a6] hover:text-[#5582a6]   hover:outline focus:outline-none'>
                <svg
                ...
                <Link href='tel:4809676888' passHref>
                  <a className='hidden text-gray-600 md:flex lg:hidden '>
                    Phone
                  </a>
                </Link>
              </button>
          ...
          <Link href='/contact' passHref>
            <a>
              <button className='text-md font-small flex items-center justify-center  space-x-2 rounded-lg border-black px-5 font-semibold text-[#107E8E] hover:border-[#5582a6] hover:text-[#5582a6] hover:outline focus:outline-none'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  className='h-6 w-6'
                  fill='none'
